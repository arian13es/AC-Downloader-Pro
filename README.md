...
دانلودر اختصاصی، آفلاین و هوشمند کلاس‌های **Adobe Connect**، طراحی‌شده به‌طور ویژه برای **سامانه tulms دانشگاه تبریز** (و سایر دانشگاه‌های ایران).

این ابزار برخلاف دانلودرهای مشابه، نیازی به ضبط صفحه نمایش (Screen Recording) یا مرورگرهای سنگین ندارد؛ بلکه با دریافت مستقیم فایل‌های خام و پردازش فایل‌های XML، **صدا، تصویر استاد و تک‌تک اسلایدهای PDF را با دقت میلی‌ثانیه (Frame-Exact) همگام‌سازی کرده** و یک فایل ویدیویی MP4 یا صوتی MP3 بی‌نقص به شما تحویل می‌دهد.
...
- **عبور از محدودیت‌های شبکه:** بهینه‌سازی شده برای دور زدن خطاهای 403 و مدیریت ریدایرکت‌های سامانه‌های دانشگاهی ایران.
...
1. وارد سامانه مدیریت یادگیری دانشگاه (مثلاً 	ulms.tabrizu.ac.ir) شوید.
...
> https://tuvc3.tabrizu.ac.ir/pih1lqf0k87a/?page=m&session=breez9iq3qa9sxnbqqq88&proto=true

![راهنمای کپی لینک](docs/url_guide.png)
